...
const styles: Record<string, React.CSSProperties> = {
  ...
  grid: {
    ...
    backgroundImage: `linear-gradient(rgba(41,121,255,0.04) 1px, transparent 1px),
  ...
  card: {
    ...
    boxShadow: '0 8px 60px rgba(0,0,0,0.5), 0 0 0 1px rgba(255,255,255,0.04) inset',
  ...
  subtitle: {
    fontSize: '0.8rem', color: '#6b84a8', margin: '0.4rem 0 0',
  ...
  inputIcon: {
    position: 'absolute', left: '0.85rem', color: '#4a6a9a',
  ...
  inputFocus: {
    ...
    color: '#e2eaf8', outline: 'none',
    boxShadow: '0 0 0 3px rgba(41,121,255,0.12)',
    transition: 'border-color .2s, box-shadow .2s',
  },
  eyeBtn: {
  ...
  btn: {
    ...
    boxShadow: '0 4px 24px rgba(41,121,255,0.35)',
  ...
  footer: {
    ...
    fontSize: '0.72rem', color: '#3a5070', letterSpacing: '0.02em',
  },
}
